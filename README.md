...
Веб-приложение для безопасного шифрования и расшифрования текстовых данных с использованием AES-256-CBC алгоритма и аутентификации через Google OAuth 2.0.
